...
contract ConditionalTokens is ERC1155 {
    ...
    function splitPosition(
        ...
        emit PositionSplit(msg.sender, collateralToken, parentCollectionId, conditionId, partition, amount, positionIds);
    }
    ...
    function mergePositions(
        ...
        if (freeIndexSet == 0) {
            if (parentCollectionId == bytes32(0)) {
                ...
                newPositionId = CTHelpers.getPositionId(collateralToken, parentCollectionId);
                _mint(
                    msg.sender,
                    newPositionId,
                    amount,
            ...
            newPositionId = CTHelpers.getPositionId(collateralToken,
                    CTHelpers.getCollectionId(parentCollectionId, conditionId, fullIndexSet ^ freeIndexSet));
            _mint(
                msg.sender,
                newPositionId,
        ...
        emit PositionsMerge(msg.sender, collateralToken, parentCollectionId, conditionId, partition, amount, newPositionId);
    }
    ...
    function redeemPositions(IERC20 collateralToken, bytes32 parentCollectionId, bytes32 conditionId, uint[] calldata indexSets) external {
        ...
        if (totalPayout > 0) {
            if (parentCollectionId == bytes32(0)) {
                ...
                newPositionId = CTHelpers.getPositionId(collateralToken, parentCollectionId);
                _mint(msg.sender, newPositionId, totalPayout, "");
            }
        }
        emit PayoutRedemption(msg.sender, collateralToken, parentCollectionId, conditionId, indexSets, totalPayout, newPositionId);
    }
    ...
    function getStringPositionId(IERC20 collateralToken, bytes32 collectionId) external pure returns (string memory) {
        return CTHelpers.getStringPositionId(collateralToken, collectionId);
    }
}
